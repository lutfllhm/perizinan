    ...
    <div className="min-h-screen relative overflow-hidden">
        ...
        {!isMobile && (
          <>
            ...
            <div 
              ...
              style={{ bottom: '20%', right: '20%', animationDelay: '1s' }}
            />
          </>
        )}
      </div>
      ...
      <section className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 pt-16">
        <div className="relative max-w-5xl mx-auto text-center">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight px-2 animate-fade-in-up">
              Sistem Perizinan
              <br />
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-200 mb-8 sm:mb-12 max-w-2xl mx-auto leading-relaxed px-4">
            ...
            {/* Stats */}
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-6 max-w-3xl mx-auto px-4">
      ...
      <footer className="relative z-10 py-8 sm:py-12 px-4 bg-black/40 backdrop-blur-sm border-t border-white/20">
        <div className="max-w-5xl mx-auto text-center text-slate-400">
          <p className="text-xs sm:text-sm">&copy; 2026 IWARE. Sistem Perizinan Digital.</p>
        </div>
      </footer>
    </div>
  );
